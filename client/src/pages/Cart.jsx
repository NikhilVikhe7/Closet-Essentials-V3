...
const PriceDetail= styled.div`
  ...
  ${mobile({flexDirection:"row", justifyContent:"space-around", marginBottom:"5px"})}
`
...
const Cart = () => {
    ...
    function handleQuantity(item, type) {
        return () =>{
            if(type === "INC"){
                ...
                <Bottom>
                    <Info>
                        {cart.products.map((item) =>(<Product>
                            <ProductDetail>
                                <Image onClick={()=> {history(`/product/${item.productId}`)}}
                                    src={item.img}></Image>
                                <Details>
                            ...
                            <PriceDetail>
                                <ProductAmountContainer>
                                    <RemoveIcon onClick={handleQuantity(item, "DEC")}/>
                                    <ProductAmount>{item.quantity}</ProductAmount>
                                    <AddIcon onClick={handleQuantity(item, "INC")}/>
                                </ProductAmountContainer>
                                <ProductPrice>{item.price}</ProductPrice>
                            </PriceDetail>
                                <CloseIcon onClick={removeItem(item)} style={{paddingRight:"20px"}}/>
                        </Product>
                        ))}
                        <Hr/>
                    </Info>
                    <Summary>
                        ...
                        <SummaryItem>
                            <SummaryItemText>Subtaotal</SummaryItemText>
